...
describe(" POST /recommendations", () => {
  ...
  it("Create a new recommendation with a conflict", async () => {
    const body = recommendationFactory();
  ...
  it("Create a new recommendation with a invalid data", async () => {
...
describe("GET /recommendations", () => {
  ...
  it(" Get empty recommendations", async () => {
    const response = await agent.get("/recommendations");
    expect(response.status).toBe(200);
...
describe("POST /upvote and /downvote", () => {
  ...
  it("Upvote a recommendation that doesn't exist", async () => {
  ...
  it("Downvote a recommendation that doesn't exist", async () => {
